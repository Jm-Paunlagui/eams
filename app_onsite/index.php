                    ...
                    <div class="carousel-item" id="logTimein">
                        <div class="row mb-5">
                            <div class="p-2 col-10 col-md-11 col-xl-12 rounded-2 text-center mx-auto text-white bgc-blue500">
                                ...
                                <form action="<?php echo BASE_URL; ?>app_onsite/process.php" method="post" id="timeinForm">
                    ...
                    <div class="carousel-item">
                        <div class="row mb-5">
                            <div class="p-2 col-10 col-md-11 col-xl-12 rounded-2 text-center mx-auto text-white bgc-yellow500">
                                ...
                                <p class="w-lg-50 mb-0" style="font-size:large;">Please tap your card.</p>
                                <form action="<?php echo BASE_URL; ?>app_onsite/process.php" method="post" id="breakoutForm">
                    ...
                    <div class="carousel-item">
                        <div class="row mb-5">
                            <div class="p-2 col-10 col-md-11 col-xl-12 rounded-2 text-center mx-auto text-white bgc-emerald600">
                                ...
                                <p class="w-lg-50 mb-0" style="font-size:large;">Please tap your card.</p>
                                <form action="<?php echo BASE_URL; ?>app_onsite/process.php" method="post" id="breakinForm">
                    ...
                    <div class="carousel-item" id="logTimeout">
                        <div class="row mb-5">
                            <div class="p-2 col-10 col-md-11 col-xl-12 rounded-2 text-center mx-auto text-white bgc-rose700">
                                ...
                                <p class="w-lg-50 mb-0" style="font-size:large;">Please tap your card.</p>
                                <form action="<?php echo BASE_URL; ?>app_onsite/process.php" method="post" id="timeoutForm">
                ...
                <div class="col-xxl-3">
                    <div class="card shadow">
                        ...
                        <div class="card-footer font-monospace p-4 py-3">
                            <h6 class="card-subtitle text-dark mb-2">Press the " <i class="bi bi-arrow-up-square-fill tc-blue500"></i> " key to activate</h6>
                        </div>
                    </div>
                </div>
                <div class="col">
                    <div class="card shadow">
                        ...
                        <div class="card-footer font-monospace p-4 py-3">
                            <h6 class="card-subtitle text-dark mb-2">Press the " <i class="bi bi-arrow-left-square-fill tc-yellow500"></i> " key to activate</h6>
                        </div>
                    </div>
                </div>
                <div class="col">
                    <div class="card shadow">
                        ...
                        <div class="card-footer font-monospace p-4 py-3">
                            <h6 class="card-subtitle text-dark mb-2">Press the " <i class="bi bi-arrow-right-square-fill tc-emerald600"></i> " key to activate</h6>
                        </div>
                    </div>
                </div>
                <div class="col">
                    <div class="card shadow">
                        ...
                        <div class="card-footer font-monospace p-4 py-3">
                            <h6 class="card-subtitle text-dark mb-2">Press the " <i class="bi bi-arrow-down-square-fill tc-rose700"></i> " key to activate</h6>
                        </div>
                    </div>
                </div>
            </div>
...
<script>
    ...
    var global_action = "";
    var activate_id = setInterval(Activate, 1000);
    ...
    $('#settingModal').on('show.bs.modal', function() {
        ...
        break_in.blur();
        time_out.blur();
        clearInterval(activate_id);
    });

    $('#settingModal').on('hidden.bs.modal', function() {

        activate_id = setInterval(Activate, 1000);
        if (global_action == "breakout") {
            break_out.focus();
        }
        ...
        $.ajax({
            ...
            success: function(data) {
                if (data.status == 'success') {
                    msg_html_breakin('<img src="<?php echo BASE_URL; ?>assets/img/' + data.image + '" width="200" style="border-radius:50%;">', data.name, data.position, data.remark);
                    form[0].reset();
    ...
    $msg_response = $session_class->getValue('onsite_status');
    if (isset($msg_response) && $msg_response != "") {
        $title = $session_class->getValue('onsite_status');
        $icon = $session_class->getValue('onsite_icon');
        echo 'msg_alert("' . $title . '","' . $icon . '");';
        $session_class->dropValue('onsite_status');
        $session_class->dropValue('onsite_icon');
    }

    $msg_login = $session_class->getValue('onsite_title');
    if (isset($msg_login) && $msg_login != "") {
        $title = $session_class->getValue('onsite_title');
        $msg = $session_class->getValue('onsite_msg');
        echo 'msg_success("' . $title . '","' . $msg . '");';
        $session_class->dropValue('onsite_title');
        $session_class->dropValue('onsite_msg');
    }
    ?>
</script>
