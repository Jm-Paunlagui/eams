        ...
        <section class="section">
            <div class="card">
                ...
                <div class="card-body mt-3">
                    <div class="card">
                        <div class="m-2">
                            <button id="add_new" class="btn btn-outline-dark btn-rounded btn-sm ml-1"><i class="bi bi-plus-circle"></i> Add User</button>
                        </div>
                        ...
                        <div class="modal-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4 mb-2">
                                    <label class="form-label" for="password"><b>Password</b> <span class="required-field"></span></label>
                                    <input type="password" name="password" class="form-control" id="password" placeholder="Password">
                                    <span id="err_password" class="badge bg-danger text-white rounded-1 p-1 mt-1 text-sm-start"></span>
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4">
                                    <label for="flag_emp" class="form-label"><b>Flag Employee</b> <span class="required-field"></span></label>
                                    <select name="flag_emp" id="flag_emp" class="form-control">
                                        <option value="" disabled selected>Select Flag Employee</option>
                                        <option value="0">Employee</option>
                                        <option value="1">User</option>
                                    </select>
                                    <span id="err_flag_emp" class="badge bg-danger text-white rounded-1 p-1 mt-1 text-sm-start"></span>
                                </div>
                            </div>
                        </div>
                    ...
                    <form id="updateForm">
                        <div class="modal-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-4">
                                    <label for="flag" class="form-label"><b>Flag Employee</b></label>
                                    <select name="flag" id="flag" class="form-control bg-light">
                                        <option value="0">Employee</option>
                                        <option value="1">User</option>
                                    </select>
                                    <input type="hidden" name="oldflag" id="oldflag">
                                    <span id="err_flag" class="badge bg-danger text-white rounded-1 p-1 mt-1 text-sm-start"></span>
                                </div>
                        ...
                        <div class="modal-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-4">
                                    ...
                                    <input type="text" name="locked_userRole" class="form-control" id="locked_userRole" disabled>
                                </div>
                                <div class="col-4">
                                    <label for="locked_flag" class="form-label"><b>Flag Employee</b></label>
                                    <input type="text" name="locked_flag" class="form-control" id="locked_flag" disabled>
                                </div>
                        ...
                        <div class="modal-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-4">
                                    ...
                                    <input type="text" name="deactivate_userRole" class="form-control" id="deactivate_userRole" disabled>
                                </div>
                                <div class="col-4">
                                    <label for="deactivate_flag" class="form-label"><b>Flag Employee</b></label>
                                    <input type="text" name="deactivate_flag" class="form-control" id="deactivate_flag" disabled>
                                </div>
...
<script>
    (function() {
        const roleClass = function(cell, formatterParams, onRendered) {
            ...
            if (data.user_role == 1) {
                ...
                span.innerHTML = "Onsite";
            } else if (data.user_role == 4) {
                span.innerHTML = "End User";
            }
            return span;
        };
        const flagClass = function(cell, formatterParams, onRendered) {
            var span = document.createElement("span");
            var row = cell.getRow();
            var data = row.getData();
            if (data.flag_employee == 0) {
                span.innerHTML = "Employee";
            } else if (data.flag_employee == 1) {
                span.innerHTML = "User";
            }
            return span;
        };
        ...
        const btnAction = function(cell, formatterParams, onRendered) { // for updating the status
            ...
            edit_btn.addEventListener("click", function() {
                ...
                if (data.account_status == 'Active') {
                    ...
                    document.getElementById("update_modal").querySelector("#flag").value = data.flag_employee;
                    document.getElementById("update_modal").querySelector("#oldflag").value = data.flag_employee;
                    ...
                    document.getElementById("err_flag").innerHTML = "";
                    document.getElementById("err_flag").style.display = "none";
                } else if (data.account_status == 'Locked') {
                    // Open the edit modal
                    ...
                    document.getElementById("locked_modal").querySelector("#locked_flag").value = data.flag_employee;
                    ...
                    document.getElementById("deactivate_modal").querySelector("#deactivate_flag").value = data.flag_employee;
            ...
            delete_btn.addEventListener("click", function() {
                swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        $.ajax({
                            url: '<?php echo BASE_URL; ?>app_admin/userprocess.php',
                            type: 'post',
                            data: formData,
                            processData: false,
                            contentType: false,
                            success: function(response) {
                                window.location.href = '<?php echo BASE_URL; ?>app_admin/user_management.php';
                            }
                        });
                    }
                })
        ...
        const table = new Tabulator("#user-table", {
            ...
            ajaxURL: "<?php echo BASE_URL; ?>app_admin/userprocess.php",
    ...
    const inputRegex = {
        ...
        cardID: /[0-9]+$/,
        userRole: /[0-9]+$/,
        // Regex for Teaching-Personnel Non-Teaching-Personnel or Teaching Personnel Non-Teaching Personnel dynamic
    ...
    function validatePassword() {
        ...
        if (password.value.trim() === "") {
            ...
            document.getElementById("err_password").style.display = "block";
            document.getElementById("err_password").innerHTML = "Must be at least 8 characters long.";
            password.focus();
            condition_state = false;
        } else if (!inputRegex.uppercase.test(password.value.trim())) {
            // If the password does not contain at least one uppercase letter, display an error message
            document.getElementById("err_password").style.display = "block";
            document.getElementById("err_password").innerHTML = "Must contain at least one uppercase letter.";
            password.focus();
            condition_state = false;
        } else if (!inputRegex.lowercase.test(password.value.trim())) {
            // If the password does not contain at least one lowercase letter, display an error message
            document.getElementById("err_password").style.display = "block";
            document.getElementById("err_password").innerHTML = "Must contain at least one lowercase letter.";
            password.focus();
            condition_state = false;
        } else if (!inputRegex.number.test(password.value.trim())) {
            // If the password does not contain at least one number, display an error message
            document.getElementById("err_password").style.display = "block";
            document.getElementById("err_password").innerHTML = "Must contain at least one number.";
            password.focus();
            condition_state = false;
        } else if (!inputRegex.special.test(password.value.trim())) {
            // If the password does not contain at least one special character, display an error message
            document.getElementById("err_password").style.display = "block";
            document.getElementById("err_password").innerHTML = "Must contain at least one special character.";
            password.focus();
            condition_state = false;
        } else {
            // If the password is not empty, clear any error messages
    ...
    function validateFlag() {
        // Get the flag input field
        const flag = document.getElementById("flag_emp");
        var condition_state;
        // Validate the flag
        if (flag.value.trim() === "") {
            // If the flag is empty, display an error message
            document.getElementById("err_flag_emp").style.display = "block";
            document.getElementById("err_flag_emp").innerHTML = "Flag employee cannot be empty.";
            flag.focus();
            condition_state = false;
        } else if (!inputRegex.flagEmp.test(flag.value.trim())) {
            // If the flag does not match the regex pattern, display an error message
            document.getElementById("err_flag_emp").style.display = "block";
            document.getElementById("err_flag_emp").innerHTML = "Invalid flag employee.";
            flag.focus();
            condition_state = false;
        } else {
            // If the flag is not empty, clear any error messages
            document.getElementById("err_flag_emp").innerHTML = "";
            document.getElementById("err_flag_emp").style.display = "none";
            condition_state = true;
        }
        return condition_state;
    }
    ...
    //     if (document.getElementById("err_emp_id").innerHTML !== "" ||
    //         document.getElementById("err_card_id").innerHTML !== "" ||
    //         document.getElementById("err_f_name").innerHTML !== "" ||
    //         document.getElementById("err_m_name").innerHTML !== "" ||
    //         document.getElementById("err_l_name").innerHTML !== "" ||
    //         document.getElementById("err_suffix").innerHTML !== "" ||
    //         document.getElementById("err_username").innerHTML !== "" ||
    //         document.getElementById("err_password").innerHTML !== "" ||
    //         document.getElementById("err_email").innerHTML !== "" ||
    //         document.getElementById("err_position").innerHTML !== "" ||
    ...
    //         return false;
    //     }
    //     // If no errors were found, allow form submission
    //     document.getElementById("err_emp_id").style.display = "none";
    //     document.getElementById("err_card_id").style.display = "none";
    //     document.getElementById("err_f_name").style.display = "none";
    //     document.getElementById("err_m_name").style.display = "none";
    //     document.getElementById("err_l_name").style.display = "none";
    //     document.getElementById("err_suffix").style.display = "none";
    //     document.getElementById("err_username").style.display = "none";
    //     document.getElementById("err_password").style.display = "none";
    //     document.getElementById("err_email").style.display = "none";
    //     document.getElementById("err_position").style.display = "none";
    ...
    function updateFlag(val) {
        ...
        if (flag.value.trim() === "") {
            // If the last name is empty, display an error message
            document.getElementById("err_flag").style.display = "block";
            document.getElementById("err_flag").innerHTML = "Flag employee cannot be empty.";
            flag.focus();
            condition_state = false;
        } else if (!inputRegex.flagEmp.test(flag.value.trim())) {
            // If the last name does not match the regex, display an error message
            document.getElementById("err_flag").style.display = "block";
            document.getElementById("err_flag").innerHTML = "Invalid flag employee.";
            flag.focus();
            condition_state = false;
        } else {
            document.getElementById("err_flag").innerHTML = "";
    ...
    $("#btn_submit").click(function(e) {
        ...
        var val_flag_employee = validateFlag();


        if (val_employee_id == false || val_card_id == false || val_f_name == false || val_m_name == false || val_l_name == false || val_username == false || val_password == false || val_email == false || val_position == false || val_user_role == false || val_flag_employee == false) {
    ...
    $("#btn_update").click(function(e) {
        ...
        var flag_employee = updateFlag(flag.trim());

        if (employeeID === oldemployeeID && cardID === oldcardID && fName === oldfName && mName === oldmName && lName === oldlName && suff === oldsuff && userName === olduserName && emailAddress === oldemailAddress && pos === oldpos && userRole === olduserRole && flag === oldflag) {
            document.getElementById("err_msg").style.display = "block";
            document.getElementById("err_msg").innerHTML = "You haven't changed any of the information.";
        } else if (emp_id == false || card_id == false || f_name == false || m_name == false || l_name == false || username == false || email == false || position == false || user_role == false || flag_employee == false) {
            document.getElementById("err_msg").innerHTML = "";
            document.getElementById("err_msg").style.display = "none";
        } else {
            document.getElementById("err_msg").innerHTML = "";
    ...
    function reset_modal(title, content_msg) {
        swal.fire({
            title: title,
            html: `<p style="font-size:16px;">Click on the button to copy the text from the text field.</p>
                    <div class="input-group outline-secondary">
                        <input type="text" value="` + content_msg + `" id="copyReset" autofocus="false" class="form-control" readonly>
                        <div class="input-group-append">
                            <button class="btn" onclick="copyText()" data-toggle="tooltip" data-placement="top" title="Copy Text"><i class="bi bi-back" style="font-size:26px;"></i></button>
                        </div>
                    </div>`,
    ...
    function copyText() {
        // Get the text field
        var copyText = document.getElementById("copyReset");
